...
public class ConnectionBBDD implements Connection {
	...
	public ConnectionBBDD(String usernameBbdd, String passwordBbdd) throws InvalidParamException {
		try {
			DriverManager.registerDriver(new OracleDriver());
			connection = DriverManager.getConnection(ConstantUtilities.NETWORK_BDD, usernameBbdd, passwordBbdd);
